...
class TestHistoricalSignalHelper(unittest.TestCase):
    ...
    def test_start_time_and_end_time_in_previous_month_should_raise_exception(self):
        ...
        self.assertTrue("Start time: year = 2017 month = 7, End time: year = 2017 month = 7. Input data: year = 2017 month = 8. Start time and end time must be within the date range of given data." in str(context.exception))
    ...
    def test_start_time_and_end_time_in_next_month_should_raise_exception(self):
        ...
        self.assertTrue("Start time: year = 2017 month = 9, End time: year = 2017 month = 9. Input data: year = 2017 month = 8. Start time and end time must be within the date range of given data." in str(context.exception))
